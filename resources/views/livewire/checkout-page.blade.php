					...
					<div class="mb-6">
						...
						<div class="grid grid-cols-2 gap-4">
							<div>
								...
								<input wire:model='name' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" id="name" type="text">
								</input>
								@error('name')
			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12">
				...
				<div class="bg-white mt-4 rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<ul class="divide-y divide-gray-200 dark:divide-gray-700" role="list">
						...
						<li class="py-3 sm:py-4" wire:key='{{ $ci['menu_id'] }}'>
							<div class="flex items-center">
								<div class="flex-shrink-0">
									<img alt="{{ $ci['name'] }}" class="w-12 h-12 rounded-full" 
									src="{{ asset('storage/' . $ci['image']) }}">
									</img>
								</div>
