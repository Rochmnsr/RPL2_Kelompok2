          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead>
              <tr>
                ...
                <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Harga Total</th>
            ...
            <tbody>
              ...
              @php
                  ...
                  if($order->status == 'canceled'){
                    $status = '<span class="bg-red-600 py-1 px-3 rounded text-white shadow">Canceled</span>';
                  }

                  if($order->payment_status == 'pending'){
                    $payment_status = '<span class="bg-green-500 py-1 px-3 rounded text-white shadow">Pending</span>';
                  }
                  if($order->payment_status == 'paid'){
                    $payment_status = '<span class="bg-cyan-500 py-1 px-3 rounded text-white shadow">Paid</span>';
                  }
